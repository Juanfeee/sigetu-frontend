...
class SedesApi {
  SedesApi({String? baseUrl}) : baseUrl = baseUrl ?? ApiConstants.baseUrl;
  ...
  Future<List<Sede>> fetchSedesActivas() async {
    final url = Uri.parse('$baseUrl/sedes').replace(
      queryParameters: const {'activos': 'true'},
    );
